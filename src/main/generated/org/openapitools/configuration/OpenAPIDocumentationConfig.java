...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .license("Copyright 2020 peopleflw")
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.employeeCenterService.base-path:}") String basePath) {
